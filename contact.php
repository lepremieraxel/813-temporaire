...
<head>
  ...
  <link
    ...
    type="image/x-icon" />
  <!-- #title -->
  <title>Contact - 813 Production</title>
  <!-- #keywords -->
  <meta
    name="keywords"
    content="Production, vidéo, portfolio, agence, contact" />
  <!-- #description -->
  <meta name="description" content="813 Production - Contact" />
  ...
  <div class="my-app">
      ...
      <div class="primary-navbar cmn-nav">
              ...
              <nav class="navbar p-0">
                <div class="navbar__logo">
                  <style>
                    ...
                    .responsive-image {
                      width: 50%;
                      /* Taille par défaut sur les écrans de bureau */
                      height: auto;
                    }

                    /* Media query pour les téléphones (largeur max 768px) */
                    @media only screen and (max-width: 768px) {
                      .responsive-image {
                        width: 50%;
                        /* Change la taille de l'image sur les téléphones */
                      }
                    }
                  </style>
                  <a href="index.html" aria-label="Aller à l'accueil">
                    <img
                      src="assets/images/logo.png"
                      alt="Logo 813 Production"
        ...
        <div class="mobile-menu">
          <nav class="mobile-menu__wrapper">
            ...
            <div
              class="mobile-menu__options d-flex d-sm-none justify-content-center nav-fade"></div>
            <div class="mobile-menu__social social nav-fade">
              <a
                href="https://www.instagram.com/813_production/"
                target="_blank"
                aria-label="Notre instagram">
                <i class="fa-brands fa-instagram"></i>
              </a>
              <a
                href="https://www.linkedin.com/company/104762499/"
                target="_blank"
                aria-label="Notre linkedin">
                <i class="fa-brands fa-linkedin-in"></i>
              </a>
              <a
                href="https://www.youtube.com/@813_production"
                target="_blank"
                aria-label="Notre YouTube">
          ...
          <div class="offcanvas-menu__list">
            <div class="navbar__menu">
              <ul>
                ...
                <li class="navbar_item nav-fade">
                  <div class="offcanvas__mobile-options d-flex">
                    <a href="contact.php" class="btn btn--secondary">Contactez-nous !</a>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <div id="smooth-wrapper">
      <div id="smooth-content">
        ...
        <main>
          <!-- ==== banner start ==== -->
          <section class="cmn-banner bg-img" data-background="">
            <div class="container">
              <div class="row gaper align-items-center">
                <div class="col-12 col-lg-5 col-xl-7">
                  <div class="text-center text-lg-start">
                    <h2 class="title title-anim">Contact</h2>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                  <div class="contact-m__single topy-tilt fade-top">
                    ...
                    <div class="content">
                      <h4>Téléphone</h4>
                      <p>
                        <a href="tel:+33603482263">Lucas : 06 03 48 22 63</a>
                      </p>
                      <p>
                        <a href="tel:+33610013260">Sémi : 06 10 01 32 60</a>
                      </p>
                      <p>
                        <a href="tel:+33783194101">Victor : 07 83 19 41 01</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
                  <div class="contact-m__single topy-tilt fade-top">
                    ...
                    <div class="content">
                      <h4>Mail</h4>
                      <p>
                        <a href="mailto:contact@813production.com">contact@813production.com</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-lg-6">
                  <div class="contact-main__form fade-top">
                    ...
                    <form
                      ...
                      method="post"
                      class="section__content-cta" id="form">
            ...
            <div class="row gaper">
              <div class="col-12 col-lg-5 col-xl-4">
                <div class="footer-two__left">
                  ...
                  <div class="paragraph">
                    <p>813 Production, la production qui vous ressemble.</p>
                  </div>
                  <div class="section__content-cta">
                    <h2>
                      ...
                      <a
                        href="mailto:contact@813production.com"
                        class="folks-text">contact@813production.com</a>
                    </h2>
                  </div>
                </div>
              </div>
              <div
                ...
                <div class="footer-two__right">
                  ...
                  <div class="footer__single-meta section__content-cta">
                    <a
                      href="https://www.google.fr/maps/place/France/@45.9889456,-2.6891104,6z/data=!3m1!4b1!4m6!3m5!1s0xd54a02933785731:0x6bfd3f96c747d9f7!8m2!3d46.227638!4d2.213749!16zL20vMGY4bDlj?entry=ttu&g_ep=EgoyMDI0MDkxOC4xIKXMDSoASAFQAw%3D%3D"
                      target="_blank">
                      <i class="fa-sharp fa-solid fa-location-dot"></i>
                      Toulouse, Bordeaux, Pau et à peu près toute la France en
                      fait
                    </a>
                    <a href="tel:+33610013260">
                      <i class="fa-sharp fa-solid fa-phone-volume"></i>
                      06 10 01 32 60
                    </a>
                    <a href="mailto:contact@813production.com">
                      <i class="fa-sharp fa-solid fa-envelope"></i>
                      contact@813production.com
                    </a>
                  </div>
                </div>
              </div>
